...
echo "What maximum batch size does your engine need? The resulting engine will be able to infer images with a batch size smaller or equal than the value you set. Input a power of 2 (1, 2, 4, 8, 16, etc)"
read max_batch_size
